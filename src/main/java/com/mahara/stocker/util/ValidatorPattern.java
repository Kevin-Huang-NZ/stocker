...
public interface ValidatorPattern {
     ...
     */
    String REGEX_YMD = "[1-2][0-9]{3}(-)\\d{1,2}\\1\\d{1,2}";

    /**
     * 正则表达式：验证密码
     * 密码只能为 8 - 20位数字，字母及常用符号组成。
     */
    String REGEX_PASSWORD = "^(?=.*[a-zA-Z])(?=.*[0-9])[A-Za-z0-9._~!@#$^&*]{8,20}$";
     ...
     * 正则表达式：验证IP地址
     */
    String REGEX_IP_ADDRESS = "(25[0-5]|2[0-4]\\d|[0-1]\\d{2}|[1-9]?\\d)";
